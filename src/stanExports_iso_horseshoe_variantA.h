...
namespace model_iso_horseshoe_variantA_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_iso_horseshoe_variantA");
    reader.add_event(64, 62, "end", "model_iso_horseshoe_variantA");
    return reader;
}
#include <stan_meta_header.hpp>
class model_iso_horseshoe_variantA
  : public stan::model::model_base_crtp<model_iso_horseshoe_variantA> {
private:
        int n_groups_stan;
...
public:
    model_iso_horseshoe_variantA(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_iso_horseshoe_variantA_namespace::model_iso_horseshoe_variantA";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::model::assign(theta, 
                        ...
                        (1.0 / stan::math::sqrt((slab_precision_stan + (1.0 / get_base1(lambda_sq, 1, "lambda_sq", 1))))), 
            ...
            stan::model::assign(theta, 
                        ...
                        (1.0 / stan::math::sqrt((slab_precision_stan + (1.0 / get_base1(lambda_sq, (n_groups_stan + 1), "lambda_sq", 1))))), 
                        "assigning variable theta");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_iso_horseshoe_variantA_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_iso_horseshoe_variantA";
    }
...
typedef model_iso_horseshoe_variantA_namespace::model_iso_horseshoe_variantA stan_model;
#ifndef USING_R
