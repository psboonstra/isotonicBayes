...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(62, 60, "end", "model_iso_horseshoe2");
    return reader;
}
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::model::assign(theta, 
                        ...
                        (1.0 / stan::math::sqrt((slab_precision_stan + (1.0 / (tau_sq * get_base1(lambda_sq, 1, "lambda_sq", 1)))))), 
            ...
            stan::model::assign(theta, 
                        ...
                        (1.0 / stan::math::sqrt((slab_precision_stan + (1.0 / (tau_sq * get_base1(lambda_sq, (n_groups_stan + 1), "lambda_sq", 1)))))), 
                        "assigning variable theta");
