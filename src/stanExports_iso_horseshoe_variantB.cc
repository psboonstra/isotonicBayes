...
#include "stanExports_iso_horseshoe_variantB.h"

RCPP_MODULE(stan_fit4iso_horseshoe_variantB_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_iso_horseshoe_variantB")
