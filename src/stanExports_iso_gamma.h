...
namespace model_iso_gamma_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_iso_gamma");
    reader.add_event(34, 32, "end", "model_iso_gamma");
    return reader;
}
#include <stan_meta_header.hpp>
class model_iso_gamma
  : public stan::model::model_base_crtp<model_iso_gamma> {
private:
        int n_groups_stan;
...
public:
    model_iso_gamma(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_iso_gamma_namespace::model_iso_gamma";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_iso_gamma_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_iso_gamma_namespace::model_iso_gamma stan_model;
#ifndef USING_R
